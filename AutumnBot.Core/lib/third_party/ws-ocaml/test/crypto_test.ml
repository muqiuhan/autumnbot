...
let assert_equal real expect =
  if real <> expect
  then (
    Printf.printf "\"%s\" expected, but got \"%s\"\n" expect real;
    failwith "assertion failed")
;;

let test () =
  print_endline "Test for Crypto";
  assert_equal (Bytes.to_string (base64encode Bytes.empty)) "";
  assert_equal (Bytes.to_string (base64encode (Bytes.of_string "ABCDE"))) "QUJDREU=";
  assert_equal
    (Bytes.to_string (base64encode (Bytes.of_string "test for crypto")))
    "dGVzdCBmb3IgY3J5cHRv";
  assert_equal
    (Bytes.to_string (base64encode (Bytes.of_string "あいうえお")))
    "44GC44GE44GG44GI44GK";
  assert_equal
    (Bytes.to_string (sha1 Bytes.empty |> hex_of_bytes))
    "da39a3ee5e6b4b0d3255bfef95601890afd80709";
  assert_equal
    (sha1 (Bytes.of_string "The quick brown fox jumps over the lazy dog")
    |> hex_of_bytes
    |> Bytes.to_string)
    "2fd4e1c67a2d28fced849ee1bb76e7391b93eb12";
  assert_equal
    (sha1 (Bytes.of_string "The quick brown fox jumps over the lazy cog")
    |> hex_of_bytes
    |> Bytes.to_string)
    "de9f2c7fd25e1b3afad3e85a0bd17d9b100db4b3";
  assert_equal
    (sha1 (Bytes.of_string "+") |> hex_of_bytes |> Bytes.to_string)
    "a979ef10cc6f6a36df6b8a323307ee3bb2e2db9c";
  assert_equal
    (sha1 (Bytes.of_string "a+=") |> hex_of_bytes |> Bytes.to_string)
    "4fbf6df71bd51610c1d3d571bf0bdc688d6ba2ff";
  assert_equal
    (sha1 (Bytes.of_string "WuBsc0JTR+sbvxG4XZuJVw==") |> hex_of_bytes |> Bytes.to_string)
  ...
  assert_equal
    (sha1
       (Bytes.of_string
          "595ffbc156f0b40f004fedb30a267a42b56cacf2c77c8b6012c7da1a7e9d8c97d55332b7ded89ca17bb3f82d7eb3ef1af50791c35bb34356b131ed6dad7fcd2d21606c0cc2014a1775c615f1f1a659ebb086586017cc8f65f696d1a6bd2a5b8506eb6a5e")
    |> hex_of_bytes
    |> Bytes.to_string)
  ...
  assert_equal
    (Bytes.of_string ("c6b8hTg4EeGb2gQMztV1/g==" ^ "258EAFA5-E914-47DA-95CA-C5AB0DC85B11")
    |> sha1
    |> base64encode
    |> Bytes.to_string)
    "Kxep+hNu9n51529fGidYu7a3wO0=";
  assert_equal
    (Bytes.of_string ("WuBsc0JTR+sbvxG4XZuJVw==" ^ "258EAFA5-E914-47DA-95CA-C5AB0DC85B11")
    |> sha1
    |> base64encode
    |> Bytes.to_string)
